...
if __name__ == "__main__":
    ...
    from mc_ocr.config import det_model_dir, raw_train_img_dir, det_visualize, \
        det_out_viz_dir, det_out_txt_dir, det_db_thresh, det_db_box_thresh

    args.image_dir = raw_train_img_dir
    ...
    for image_file in image_file_list:
        ...
        txt_name = os.path.splitext(img_name_pure)[0] + ".txt"
        output_txt_path = os.path.join(det_out_txt_dir, txt_name)
